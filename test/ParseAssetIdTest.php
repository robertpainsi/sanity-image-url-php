...
class ParseAssetIdTest extends TestCase
{
    public function testThrowsOnInvalidDocumentId()
    {
        ...
        $this->expectExceptionMessage(
            "Malformed asset _ref 'moop'. Expected an id like \"image-Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000-jpg\"."
        );
    ...
    public function testThrowsOnInvalidDimensions()
    {
        ...
        // phpcs:ignore Generic.Files.LineLength.TooLong
            "Malformed asset _ref 'image-assetId-mooxmoo-png'. Expected an id like \"image-Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000-jpg\"."
        );
