...
class ImageFixtures {
	...
	public static function uncroppedImage() {
		return [
			'_type'   => 'image',
			'asset'   => [
	...
	public static function materializedAssetWithCrop() {
		return [
			'_type'   => 'image',
			'asset'   => [
	...
	public static function croppedImage() {
		return [
			'_type'   => 'image',
			'asset'   => [
				'_ref'  => 'image-Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000-jpg',
	...
	public static function croppedLandscapeImageRounding() {
		return [
			'_type'   => 'image',
			'asset'   => [
	...
	public static function croppedPortraitImageRounding() {
		return [
			'_type'   => 'image',
			'asset'   => [
	...
	public static function noHotspotImage() {
		return [
			'_type' => 'image',
			'asset' => [
				'_ref'  => 'image-Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000-jpg',
	...
	public static function assetWithUrl() {
		return [
			'asset' => [
				'url' => 'https://cdn.sanity.io/images/ppsg7ml5/test/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg',
			],
	...
	public static function assetDocument() {
		return [
			'_id'       => 'image-Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000-jpg',
			'_type'     => 'sanity.imageAsset',
