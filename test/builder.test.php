	...
	public function casesProvider() {
		...
		return [
			...
			[
				...
				'actual'   => $urlFor->image( ImageFixtures::imageWithNoCropSpecified() )
				                     ->width( 80 )
				                     ->url(),
			...
			[
				...
				'actual'   => $this->stripPath(
					$urlFor->image( 'image-928ac96d53b0c9049836c86ff25fd3c009039a16-1200x966-jpg' )
					       ->width( 1000 )
					       ->height( 805 )
					       ->url()
				),
			...
			[
				...
				'actual'   => $this->stripPath(
					$urlFor->image( ImageFixtures::croppedImage() )
					       ->maxWidth( 200 )
					       ->minWidth( 100 )
					       ->maxHeight( 300 )
					       ->minHeight( 150 )
